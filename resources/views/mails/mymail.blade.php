...
<html lang="en">
  ...
  text-align: !important;">
        ...
        <div style="right;white-space:nowrap !important;"><a style="color:#FFA500;  text-decoration: underline !important;" href="mailto:company@example.com">elitecarrentalke@gmail.com</a></div>
      </div>
      ...
      <div style="float: left !important;">
        ...
        <div style="white-space: nowrap !important;"><span style="color:#5D6975;text-align: right;width: 52px;margin-right: 10px;display:inline-block;font-size: 0.8em !important;">CLIENT</span> John Doe</div>
        ...
        <div style="white-space: nowrap !important;"><span style="color:#5D6975;text-align: right;width: 52px;margin-right: 10px;display:inline-block;font-size: 0.8em !important;">EMAIL</span> <a style="color:#FFA500;  text-decoration: underline !important;" href="mailto:john@example.com">john@example.com</a></div>
        <div style="white-space: nowrap !important;"><span style="color:#5D6975;text-align: right;width: 52px;margin-right: 10px;display:inline-block;font-size: 0.8em !important;">DATE</span> August 17, 2015</div>
        <div style="white-space: nowrap !important;"><span style="color:#5D6975;text-align: right;width: 52px;margin-right: 10px;display:inline-block;font-size: 0.8em !important;">DUE DATE</span> September 17, 2015</div>
      </div>
    </header>
  ...
  font-weight:normal; text-align: center !important;">TOTAL</th>
        ...
        <tbody>
          <tr style="background: #F5F5F5 !important;">
            ...
            <td style="padding:20px;text-align:left;vertical-align:top !important;">Car model X was rented by John Doe on 12th May, 2020</td>
            <td style="font-size:1.2em;padding: 20px;
  text-align: center !important;">4450</td>
            <td style="font-size:1.2em;padding: 20px;
  text-align: center !important;">2</td>
            <td style="font-size:1.2em;padding: 20px;
  text-align: center !important;">8900</td>
          </tr>


          <tr>
            <td style="padding: 20px;text-align: left;vertical-align: top !important;">Car Servicing</td>
            <td style="padding:20px;text-align: left;vertical-align:top !important;">Car Model X was serviced at our station on 12th May, 2020</td>
            <td style="font-size:1.2em;padding: 20px;
  text-align: center !important;">1500</td>
            <td style="font-size:1.2em;padding: 20px;
  ...
  text-align: center !important;">1500</td>
          ...
          <tr style="background: #F5F5F5 !important;">
            ...
            <td style="padding:20px;text-align: left;vertical-align:top !important;">Car was delivered to Serena Hotel, Nairobi at 11:00am on 12th May, 2020</td>
            <td  style="font-size:1.2em;padding: 20px;
  text-align: center !important;">1600</td>
            <td style="font-size:1.2em;padding: 20px;
  text-align: center !important;">1</td>
            <td style="font-size:1.2em;padding: 20px;
  text-align: center !important;">800.00</td>
          </tr>


          <tr>
            <td style="padding: 20px;text-align: left;vertical-align: top !important;">Car Wash</td>
            <td style="padding:20px;text-align:left;vertical-align:top !important;">The car model X was washed at our station on 12th May,2020</td>
            <td  style="font-size:1.2em;padding: 20px;
  text-align: center !important;">800</td>
            <td style="font-size:1.2em;padding: 20px;
  text-align: center !important;">1</td>
            <td style="font-size:1.2em;padding: 20px;
  text-align: center !important;">800</td>
          ...
          <tr>
            <td colspan="4" style="padding:20px;text-align:right;">SUBTOTAL</td>
            <td style="font-size:1.2em;padding: 20px;
  text-align: center !important;">12800</td>
          </tr>


          <tr>
            <td colspan="4" style="padding:20px;text-align:right;">TAX 25%</td>
            <td style="font-size:1.2em;padding: 20px;
  text-align: center !important;">1560</td>
          </tr>


          <tr>
            <td colspan="4" style="padding:20px;text-align:right; border-top: 1px solid #5D6975 !important;">GRAND TOTAL</td>
            <td style="padding:20px;text-align:right; border-top: 1px solid #5D6975 !important;">14360</td>
          </tr>
