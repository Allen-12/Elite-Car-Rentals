    ...
    <body>
        <div id="app">
            <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar" style="background-image: url('{{ asset('images/car1.jpg') }}">
                <div class="container">
                    <a class="navbar-brand" href="/admin"><img src = "{{ asset('images/elitelogo2.png') }}" style="height: 100px; width: 130px;" ></a>
                    ...
                    <div class="collapse navbar-collapse" id="ftco-nav">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item active"><a href="/admin" class="nav-link"><h5 style=" font:sans-serif">Home</h5></a></li>
